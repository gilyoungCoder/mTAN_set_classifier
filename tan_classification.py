...
if __name__ == '__main__':
    ...
    params = (list(rec.parameters()) + list(dec.parameters()) + list(classifier.parameters()) + list(set_trans.parameters()))
    print('parameters:', utils.count_parameters(rec), utils.count_parameters(dec), utils.count_parameters(classifier), utils.count_parameters(set_trans))
    ...
    for itr in range(1, args.niters + 1):
        ...
        for train_batch, label in train_loader:
            ...
            combined_z0 = torch.cat((z0, query_expanded*math.sqrt(dim)), dim=2)   
